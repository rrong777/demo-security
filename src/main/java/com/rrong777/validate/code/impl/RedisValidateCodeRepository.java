...
import com.rrong777.validate.code.ValidateCodeRepository;
import com.rrong777.validate.code.ValidateCodeType;
 ...
 * 这个和session的 不能同时使用，这个要求多一个deviceId参数，而session的是用浏览器的，这个是用app的
 */
@Component
